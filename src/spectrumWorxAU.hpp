...
class SpectrumWorxAU final : public SpectrumWorxSharedImpl<SpectrumWorxAU, Plugins::Protocol::AU>
{
  private:
  ...
  public: // Plugin framework interface
    explicit SpectrumWorxAU(PluginPlatform::ConstructionParameter const pluginBaseParam)
