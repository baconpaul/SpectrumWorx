...
template <> struct ErrorCode<Protocol::Unity>
{
    enum value_type
    {
...
template <> struct AutomatedParameterFor<Protocol::Unity>
{
...
class UnityPluginBase : private UnityHostProxy, public ErrorCode<Protocol::Unity>
{
...
template <> class ParameterInformation<Protocol::Unity> : private UnityAudioParameterDefinition
{
  public:
  ...
  private:
    template <class Parameter, typename Tag> void setValues(Tag)
    {
...
class LE_ALIGN(16) Plugin<ImplParam, Protocol::Unity> : public UnityPluginBase
{
  protected:
  ...
  protected: // Default implementations for host -> plugin events/callbacks (user
    ...
    static bool getParameterProperties(unsigned int /*index*/, ParameterInformation &)
    {
        return false;
    }
  ...
  private:
        ...
        ::UnityAudioEffectDefinition const *const **const ppDefinitions)
    {
        ...
        static UnityAudioEffectDefinition /*const*/ definition = {
            ...
            /*flags            */
            usesSideChain ? UnityAudioEffectDefinitionFlags_IsSideChainTarget : 0,
            /*name[ 32 ]       */ {/*Impl::name*/},
            ...
            /*paramdefs        */
            const_cast<UnityAudioParameterDefinition *>(&parameterDefinitions[0].abiStructure()),
...
extern int
UnityGetAudioEffectDefinitionsImpl(::UnityAudioEffectDefinition const *const **ppDefinitions);
