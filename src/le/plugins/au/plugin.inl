...
struct Plugin<Impl, Protocol::AU>::AudioComponentPlugInInstance : ::AudioComponentPlugInInterface
{
  public:
    ...
    typename std::aligned_storage<sizeof(Impl), std::alignment_of<Impl>::value>::type
        implPlaceholder;
  ...
  public:
    ...
    {
        LE_ASSUME(pSelf);
        AudioComponentPlugInInstance *LE_RESTRICT const pInstance(
            static_cast<AudioComponentPlugInInstance *>(pSelf));
        return *pInstance;
    }
    ...
    Impl const &LE_RESTRICT impl() const
    {
        return const_cast<AudioComponentPlugInInstance &>(*this).impl();
    }
  ...
  public: // Callbacks
    ...
    static AudioComponentMethod LE_NOTHROW lookup(::SInt16 const selector)
    {
        ...
        case kAudioUnitInitializeSelect:
            return reinterpret_cast<AudioComponentMethod>(AUMethodInitialize);
        case kAudioUnitUninitializeSelect:
            return reinterpret_cast<AudioComponentMethod>(AUMethodUninitialize);
        case kAudioUnitGetPropertyInfoSelect:
            return reinterpret_cast<AudioComponentMethod>(AUMethodGetPropertyInfo);
        case kAudioUnitGetPropertySelect:
            return reinterpret_cast<AudioComponentMethod>(AUMethodGetProperty);
        case kAudioUnitSetPropertySelect:
            return reinterpret_cast<AudioComponentMethod>(AUMethodSetProperty);
        case kAudioUnitAddPropertyListenerSelect:
            return reinterpret_cast<AudioComponentMethod>(AUMethodAddPropertyListener);
#if (!__LP64__)
        case kAudioUnitRemovePropertyListenerSelect:
            return reinterpret_cast<AudioComponentMethod>(AUMethodRemovePropertyListener);
#endif
        case kAudioUnitRemovePropertyListenerWithUserDataSelect:
            return reinterpret_cast<AudioComponentMethod>(
                AUMethodRemovePropertyListenerWithUserData);
        case kAudioUnitAddRenderNotifySelect:
            return reinterpret_cast<AudioComponentMethod>(AUMethodAddRenderNotify);
        case kAudioUnitRemoveRenderNotifySelect:
            return reinterpret_cast<AudioComponentMethod>(AUMethodRemoveRenderNotify);
        case kAudioUnitGetParameterSelect:
            return reinterpret_cast<AudioComponentMethod>(AUMethodGetParameter);
        case kAudioUnitSetParameterSelect:
            return reinterpret_cast<AudioComponentMethod>(AUMethodSetParameter);
        case kAudioUnitScheduleParametersSelect:
            return reinterpret_cast<AudioComponentMethod>(AUMethodScheduleParameters);
        case kAudioUnitRenderSelect:
            return reinterpret_cast<AudioComponentMethod>(AUMethodRender);
        case kAudioUnitResetSelect:
            return reinterpret_cast<AudioComponentMethod>(AUMethodReset);
    ...
    static OSStatus LE_NOTHROW AUMethodInitialize(This &LE_RESTRICT instance)
    {
        ...
        if (!impl.processBlockSize())
        {
            ...
            OSStatus const blockSizeResult(
                makeErrorCode(impl.setBlockSize(defaultAUProcessingBlockSize)));
            if (blockSizeResult != noErr)
                return LE_TRACE_RETURN(blockSizeResult,
                                                       ...
                                                       Boolean *LE_RESTRICT const pWritable)
    {
        ...
        LE_TRACE_IF(result != noErr,
                    "\tSW AU: getPropertyInfo() failed with " LE_OSX_INT_FORMAT(
                        d) " for %s/" LE_OSX_INT_FORMAT(u) ".",
                    result, infoGetter.pPropertyName, propertyID);

        if (pDataSize)
            *pDataSize = infoGetter.dataSize;
        if (pWritable)
            *pWritable = infoGetter.writable;
                        ...
                        void *const pOutData, UInt32 *LE_RESTRICT const pDataSize)
    {
        ...
        {
            LE_TRACE(
                "\tSW AU: getProperty(): null input data pointer (propertyID " LE_OSX_INT_FORMAT(
                    u) ").\n",
                propertyID);
        ...
        *pDataSize = getter.dataSize;
        ...
        LE_TRACE_IF(result != noErr,
                    "\tSW AU: getProperty() failed with " LE_OSX_INT_FORMAT(
                        d) " for %s/" LE_OSX_INT_FORMAT(u) ".",
                    result, getter.pPropertyName, propertyID);
        return result;
    }
                                                   ...
                                                   void const *const pInData, UInt32 const dataSize)
    {
        ...
        if (element > 1) // Ableton Live 8.3.4 & kAudioUnitProperty_StreamFormat
            return LE_TRACE_RETURN(kAudioUnitErr_InvalidElement,
                                   "\tSW AU: host tried to set property " LE_OSX_INT_FORMAT(
                                       u) " for non existent bus " LE_OSX_INT_FORMAT(u) ".",
                                   propertyID, element);
        ...
        LE_TRACE_IF(result != noErr,
                    "\tSW AU: setProperty() failed with " LE_OSX_INT_FORMAT(
                        d) " for %s/" LE_OSX_INT_FORMAT(u) ".",
                    result, setter.pPropertyName, propertyID);
                         ...
                         ::AudioUnitParameterValue const value, ::UInt32 const bufferOffset)
    {
        ...
        ///                                   (12.11.2015.) (Domagoj Saric)
        LE_TRACE_IF(bufferOffset != 0,
                    "\tSW AU: host tried to make a scheduled set of parameter " LE_OSX_INT_FORMAT(
                        u) " (offset " LE_OSX_INT_FORMAT(u) ").",
                    parameterID, bufferOffset);
        ...
        ::UInt32 const numberOfSamples, ::AudioBufferList *LE_RESTRICT const pIOData)
    {
        ...
        ::AudioUnitRenderActionFlags &LE_RESTRICT ioActionFlags(pIOActionFlags ? *pIOActionFlags
                                                                               : dummyActionFlags);

        impl.sendRenderNotification(kAudioUnitRenderAction_PreRender, ioActionFlags, *pTimeStamp,
                                    outputBusNumber, numberOfSamples, *pIOData);
        ...
        OSStatus const mainRenderResult(impl.inputConnections_[0](
            ioActionFlags, pTimeStamp, numberOfSamples,
        ...
        OSStatus const sideRenderResult(
            hasSideChannel ? impl.inputConnections_[1](ioActionFlags, pTimeStamp, numberOfSamples,
                                                       nullptr, numberOfChannels)
                           : noErr);
        ...
        if (BOOST_LIKELY((mainRenderResult == noErr) && (sideRenderResult == noErr)))
        {
            ...
            if (callerProvidedOutputBuffer &&
                (!impl.shouldAllocateOutputBuffer_ ||
                 ignoreShouldAllocateOutputBufferIfProvidedBuffer) &&
            ...
            ::AudioBuffer const *LE_RESTRICT const pSideInput(
                impl.inputConnections_[1].buffers().mBuffers);
            if (hasSideChannel)
            {
            ...
            float *__restrict pOutputChannels[numberOfMainChannels];
            {
                ...
                for (std::uint8_t channel(0); channel < numberOfMainChannels; ++channel)
                {
                    pInputChannels[channel] = static_cast<float const *>(pMainInput[channel].mData);
                }
                for (std::uint8_t channel(0); channel < numberOfSideChannels; ++channel)
                {
                    pInputChannels[channel + numberOfMainChannels] =
                        static_cast<float const *>(pSideInput[channel].mData);
                }
                for (std::uint8_t channel(0); channel < numberOfMainChannels; ++channel)
                {
                    pOutputChannels[channel] = static_cast<float *>(pOutput[channel].mData);
                }
            }
        ...
        impl.sendRenderNotification(
            kAudioUnitRenderAction_PostRender |
                (mainRenderResult != noErr ? kAudioUnitRenderAction_PostRenderError : 0),
            ioActionFlags, *pTimeStamp, outputBusNumber, numberOfSamples, *pIOData);
...
namespace
{
unsigned int actualParameterIndex(unsigned int const index, unsigned int const totalParameters)
{
    ...
    unsigned int const actualIndex((static_cast<int>(wouldBeActualIndex) < 0) ? 0
                                                                              : wouldBeActualIndex);
#endif
#elif defined(_WIN32)
...
Parameter const &parameter(::ComponentParameters *LE_RESTRICT const pParameters,
                           unsigned int const index, unsigned int const totalParameters)
{
    LE_ASSUME(index < totalParameters);
    unsigned int const actualIndex(actualParameterIndex(index, totalParameters));
    Parameter const &parameter(
        reinterpret_cast<Parameter const &>(pParameters->params[actualIndex]));
    return parameter;
}
} // anonymous namespace
    ...
    ::ComponentParameters *LE_RESTRICT const pParameters, ::Handle const userDataHandle)
{
    ...
    if (selector == kComponentOpenSelect)
    {
        ...
        AudioComponentPlugInInstance *LE_RESTRICT const pInstance(new (std::nothrow)
                                                                      AudioComponentPlugInInstance);
        if (!pInstance)
            return kAudio_MemFullError;
    ...
    case kComponentVersionSelect:
    {
        UInt32 const version(Impl::versionMajor << 16 | Impl::versionMinor << 8 |
                             Impl::versionPatch);
        return version;
    }
    ...
    case kAudioUnitGetPropertySelect:
    {
        ...
        if (propertyID == kAudioUnitProperty_FastDispatch)
        {
            ...
            AudioComponentMethod const pMethod(
                AudioComponentPlugInInstance::lookup(fastDispatchSelector));
            if (pMethod)
            {
            ...
            {
                LE_TRACE("FastDispatch requested for unimplemented selector (%hd)",
                         fastDispatchSelector);
                *pDataSize = 0;
                return kAudio_UnimplementedError;
            }
        }
...
template <class Impl> Impl &Plugin<Impl, Protocol::AU>::impl() /// \throws nothing
{
...
LE_ENTRY_POINT_BEGIN(::ComponentResult, lePluginAUEntry,
                     ::ComponentParameters *LE_RESTRICT const pParameters,
                     ::Handle const userDataHandle)
{
    return ::LE::Plugins::Plugin<Impl, ::LE::Plugins::Protocol::AU>::componentManagerEntry(
        pParameters, userDataHandle);
}
LE_ENTRY_POINT_END()
...
LE_ENTRY_POINT_BEGIN(AudioComponentPlugInInterface *,
                     lePluginAUFactory, // AudioComponentFactoryFunction
                     ::AudioComponentDescription const *LE_RESTRICT const pDescription)
{
    typedef
        typename ::LE::Plugins::Plugin<Impl,
                                       ::LE::Plugins::Protocol::AU>::AudioComponentPlugInInstance
            AudioComponentPlugInInstance;
...
#else
#define LE_PLUGIN_AU_ENTRY_POINT(implClass)                                                        \
    extern "C" LE_ENTRY_POINT_ATTRIBUTES ::ComponentResult __cdecl lePluginAUEntry(                \
        ::ComponentParameters *LE_RESTRICT const pParameters, ::Handle const userDataHandle)       \
    {                                                                                              \
        return ::lePluginAUEntryImpl<implClass>(pParameters, userDataHandle);                      \
    }                                                                                              \
                                                                                                   \
    extern "C" LE_ENTRY_POINT_ATTRIBUTES AudioComponentPlugInInterface *__cdecl lePluginAUFactory( \
        ::AudioComponentDescription const *LE_RESTRICT const pDescription)                         \
    {                                                                                              \
