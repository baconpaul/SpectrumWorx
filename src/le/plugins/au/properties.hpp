...
{
    template <class Impl>
    static unsigned int get(Impl const &, ::AudioUnitScope, ::AudioUnitElement)
    {
        return 1;
    }
};

template <class Impl, AudioUnitPropertyID PropertyID> struct PropertyHandler
{
    ...
    template <typename T>
    static OSStatus get(Impl const &, AudioUnitScope, AudioUnitElement, T const &)
    {
        return kAudio_UnimplementedError;
    }
    template <typename T>
    static OSStatus set(Impl const &, AudioUnitScope, AudioUnitElement, T const &)
    {
        return kAudio_UnimplementedError;
    }
};

template <typename Source, typename Target> struct CopyConstness
{
    typedef Target type;
};
template <typename Source, typename Target> struct CopyConstness<Source const, Target>
{
    typedef Target const type;
};

template <typename PropertyType> struct PropertyTypeTraits
{
    ...
    static param_type make(void *const pOutData, UInt32 &size)
    {
        ...
        LE_TRACE_IF((size != sizeof(value_type)),
                    "AU: Invalid property buffer size (required %lu, provided %u)",
...
template <typename PropertyType> struct PropertyTypeTraits<Array<PropertyType>>
{
...
template <> struct PropertyTypeTraits<::HostCallbackInfo>
{
    ...
    static param_type make(void *const pOutData,
                           UInt32 &size) //...mrmlj...copy pasted non specialized version...
    {
        LE_ASSUME(pOutData);
        LE_TRACE_IF((size != sizeof(value_type)),
                    "AU: Invalid property buffer size (required %lu, provided %u)",
    ...
    static const_param_type make(void const *const pInData, UInt32 const size)
    {
        ...
        else
        {
            ...
            LE_TRACE("Storage provided for HostCallbackInfo smaller than sizeof HostCallbackInfo "
                     "(%u < %u)",
                     size, sizeof(value));
...
template <> struct PropertyTypeTraits<::AUHostVersionIdentifier> //...mrmlj...for StudioOne 2.6.3
{
    ...
    static const_param_type make(void const *const pInData, UInt32 const size)
    {
        ...
        {
            static value_type value;
            LE_TRACE("Storage provided for AUHostVersionIdentifier smaller than sizeof "
                     "AUHostVersionIdentifier (%u < %u)",
                     size, sizeof(value));
            std::memcpy(&value, pInData, size);
            std::memset(reinterpret_cast<char *>(&value) + size, 0, sizeof(value) - size);
            return value;
...
template <AudioUnitPropertyID PropertyID> struct PropertyChangeDetector
{
    template <class Impl>
...
#define LE_AU_PROPERTY_DEBUGGER_SET_PROPERTY(functor, propertyID)                                  \
    functor.pPropertyName = PropertyTraits<propertyID>::name()
#else
...
template <AudioUnitPropertyID propertyID> AudioUnitScope adjustScope(AudioUnitScope const scope)
{
    return scope;
}
template <>
inline AudioUnitScope adjustScope<kAudioUnitProperty_StreamFormat>(AudioUnitScope const scope)
{
    return (scope == kAudioUnitScope_Global) ? kAudioUnitScope_Output : scope;
}
template <>
inline AudioUnitScope adjustScope<kAudioUnitProperty_SampleRate>(AudioUnitScope const scope)
{
    return adjustScope<kAudioUnitProperty_StreamFormat>(scope);
}
...
#define LE_AU_PROPERTIES_SELECT_FUNCTION(propertiesSequence)                                       \
    ...
    {                                                                                              \
        ...
        switch (propertyID)                                                                        \
        {                                                                                          \
            BOOST_PP_SEQ_FOR_EACH(LE_AU_PROPERTIES_SELECT_FUNCTION_CASE, 0, propertiesSequence)    \
        }                                                                                          \
        return kAudio_UnimplementedError;                                                          \
    }
...
#define LE_AU_PROPERTIES_TRAITS(r, data, propertyInfoTuple)                                        \
    ...
    {                                                                                              \
        ...
        {                                                                                          \
            return std::strchr(                                                                    \
                BOOST_PP_STRINGIZE( BOOST_PP_TUPLE_ELEM( 7, 0, propertyInfoTuple ) ), '_') + 1;          \
        }                                                                                          \
    };
...
LE_AU_PROPERTIES( // 0: ID                                          1: type                               2: w           3: r  4: scope0               5: scope1             6:implemented
    ((kAudioUnitProperty_ClassInfo, ::CFPropertyListRef, Yes, Yes, kAudioUnitScope_Global,
      kAudioUnitScope_Part,
      1))((kAudioUnitProperty_MakeConnection, ::AudioUnitConnection, Yes, No, kAudioUnitScope_Input,
           -1, 1))((kAudioUnitProperty_SampleRate, ::Float64, Yes, Yes, kAudioUnitScope_Input,
                    kAudioUnitScope_Output, 1))(
        (kAudioUnitProperty_ParameterList, Array<::AudioUnitParameterID>, No, Yes, -1, -1,
         1))((kAudioUnitProperty_ParameterInfo, ::AudioUnitParameterInfo, No, Yes, -1, -1,
              1))((kAudioUnitProperty_CPULoad, ::Float64, No, Yes, kAudioUnitScope_Global, -1, 0))(
        (kAudioUnitProperty_StreamFormat, ::AudioStreamBasicDescription, Yes, Yes,
         kAudioUnitScope_Input, kAudioUnitScope_Output,
         1))((kAudioUnitProperty_ElementCount, ::UInt32, RuntimeQuery, Yes, -1, -1,
              1))((kAudioUnitProperty_Latency, ::Float64, No, Yes, kAudioUnitScope_Global, -1,
                   1))((kAudioUnitProperty_SupportedNumChannels, Array<::AUChannelInfo>, No, Yes,
                        kAudioUnitScope_Global, -1,
                        1))((kAudioUnitProperty_MaximumFramesPerSlice, ::UInt32, Yes, Yes,
                             kAudioUnitScope_Global, -1,
                             1))((kAudioUnitProperty_ParameterValueStrings, ::CFArrayRef, No, Yes,
                                  kAudioUnitScope_Global, -1,
                                  1))((kAudioUnitProperty_AudioChannelLayout, ::AudioChannelLayout,
                                       Yes, Yes, kAudioUnitScope_Input, kAudioUnitScope_Output, 0))(
        (kAudioUnitProperty_TailTime, ::Float64, No, Yes, kAudioUnitScope_Global, -1,
         1))((kAudioUnitProperty_BypassEffect, ::UInt32, Yes, Yes, kAudioUnitScope_Global, -1,
              0))((kAudioUnitProperty_LastRenderError, ::OSStatus, No, Yes, kAudioUnitScope_Global,
                   -1, 1))((kAudioUnitProperty_SetRenderCallback, ::AURenderCallbackStruct, Yes, No,
                            kAudioUnitScope_Input, -1, 1))((kAudioUnitProperty_FactoryPresets,
                                                            ::CFArrayRef /*AUPreset*/, No, Yes,
                                                            kAudioUnitScope_Global, -1, 0))(
        (kAudioUnitProperty_RenderQuality, ::UInt32, Yes, Yes, kAudioUnitScope_Global, -1,
         0))((kAudioUnitProperty_InPlaceProcessing, ::UInt32, Yes, Yes, kAudioUnitScope_Global, -1,
              1))((kAudioUnitProperty_ElementName, ::CFStringRef, Yes, Yes, -1, -1, 1))(
        (kAudioUnitProperty_SupportedChannelLayoutTags, Array<::AudioChannelLayoutTag>, No, Yes,
         kAudioUnitScope_Input, kAudioUnitScope_Output,
         0))((kAudioUnitProperty_PresentPreset, ::AUPreset, Yes, Yes, kAudioUnitScope_Global,
              kAudioUnitScope_Part, 1))((kAudioUnitProperty_ShouldAllocateBuffer, ::UInt32, Yes,
                                         Yes, kAudioUnitScope_Input, kAudioUnitScope_Output, 1))
    ...
    ((kAudioUnitProperty_SetExternalBuffer, ::AudioUnitExternalBuffer, Yes, No,
      kAudioUnitScope_Global, -1, 0))
    ...
    ((kAudioUnitProperty_ContextName, ::CFStringRef, Yes, Yes, kAudioUnitScope_Global, -1, 0))((
        kAudioUnitProperty_HostCallbacks, ::HostCallbackInfo, Yes, Yes, kAudioUnitScope_Global, -1,
        1)) // not readable according to documentation but yes according to OSX10.6 auval and AUBase.cpp
    ((kAudioUnitProperty_CocoaUI, ::AudioUnitCocoaViewInfo, No, Yes, kAudioUnitScope_Global, -1,
      1))((kAudioUnitProperty_ParameterIDName, ::AudioUnitParameterNameInfo, No, Yes, -1, -1,
           1)) //...mrmlj...enabled only for testing host behaviour...
    ((kAudioUnitProperty_ParameterClumpName, ::AudioUnitParameterNameInfo, No, Yes, -1, -1, 0))(
        (kAudioUnitProperty_ParameterStringFromValue, ::AudioUnitParameterStringFromValue, No, Yes,
         -1, -1, 1))((kAudioUnitProperty_OfflineRender, ::UInt32, Yes, Yes, kAudioUnitScope_Global,
                      -1, 0))((kAudioUnitProperty_ParameterValueFromString,
                               ::AudioUnitParameterValueFromString, No, Yes, -1, -1, 0))(
        (kAudioUnitProperty_IconLocation, ::CFURLRef, No, Yes, kAudioUnitScope_Global, -1,
         0))((kAudioUnitProperty_PresentationLatency, ::Float64, Yes, No, kAudioUnitScope_Input,
              kAudioUnitScope_Output,
              0))((kAudioUnitProperty_DependentParameters, Array<::AUDependentParameter>, No, Yes,
                   -1, -1, 1))((kAudioUnitProperty_AUHostIdentifier, ::AUHostVersionIdentifier, Yes,
                                No, kAudioUnitScope_Global, -1, 1))(
        (kAudioUnitProperty_MIDIOutputCallbackInfo, ::CFArrayRef, No, Yes, kAudioUnitScope_Global,
         -1, 0))((kAudioUnitProperty_MIDIOutputCallback, ::AUMIDIOutputCallbackStruct, Yes, No,
                  kAudioUnitScope_Global, -1,
                  0))((kAudioUnitProperty_InputSamplesInOutput,
                       ::AUInputSamplesInOutputCallbackStruct, Yes, Yes, kAudioUnitScope_Global, -1,
                       0))((kAudioUnitProperty_ClassInfoFromDocument, ::CFDictionaryRef, Yes, Yes,
                            kAudioUnitScope_Global, -1, 0))((kAudioUnitProperty_FrequencyResponse,
                                                             ::AudioUnitFrequencyResponseBin, No,
                                                             Yes, kAudioUnitScope_Global, -1, 0))
...
struct PropertyInfoGetter
{
    ...
    result_type apply(Impl const &impl, ::AudioUnitScope const scope,
                      ::AudioUnitElement const element)
    {
        ...
        {
            LE_TRACE("AU: Invalid scope (" LE_OSX_INT_FORMAT(u) ") for property (%s).", scope,
                     Handler::name());
            return scopeResult;
        }
                      ...
                      ::AudioUnitElement const element) const
    {
        ...
        if (scopeResult != noErr)
            return LE_TRACE_RETURN(
                scopeResult, "\tSW AU: Invalid scope (" LE_OSX_INT_FORMAT(u) ") for property (%s).",
                scope, Handler::name());

        LE_ASSUME((Handler::readable));

        return apply<PropertyID>(
            impl, scope, element,
            std::integral_constant<bool, Handler::implemented && Handler::readable>());
    }

    template <unsigned PropertyID, class Impl>
    result_type apply(Impl const &impl, ::AudioUnitScope const scope,
                      ::AudioUnitElement const element, std::true_type) const
    {
        using namespace Detail;
        ...
        if (dataSize < sizeof(value_type))
            return LE_TRACE_RETURN(
                ...
                "\tSW AU: Too small property (%s) buffer size (required %lu, provided %u).",
                Handler::name(), sizeof(value_type), static_cast<unsigned int>(dataSize));
        if (Handler::TypeTraits::array)
        {
            UInt32 const minimumSize(PropertyValueCount<PropertyID>::get(impl, scope, element) *
                                     sizeof(value_type));
            LE_ASSUME(dataSize >= minimumSize);
            dataSize = std::min(dataSize, minimumSize);
        }

        return PropertyHandler<Impl, PropertyID>::get(
            impl, scope, element, Handler::TypeTraits::make(pOutData, dataSize));
    }

    template <unsigned PropertyID, class Impl>
    result_type apply(Impl const &, ::AudioUnitScope, ::AudioUnitElement, std::false_type) const
    {
        return kAudio_UnimplementedError;
    }
...
struct PropertySetter
{
    ...
    result_type apply(Impl &impl, AudioUnitScope const scope, AudioUnitElement const element) const
    {
        ...
        return apply<PropertyID>(
            impl, scope, element,
            std::integral_constant<bool, PropertyTraits<PropertyID>::implemented &&
                                             PropertyTraits<PropertyID>::writable != No>());
    }

    template <unsigned PropertyID, class Impl>
    result_type apply(Impl &impl, AudioUnitScope const scope, AudioUnitElement const element,
                      std::true_type) const
    {
        using namespace Detail;
        ...
        result_type const result(PropertyHandler<Impl, PropertyID>::set(
            impl, scope, element,
            PropertyTraits<PropertyID>::TypeTraits::make(pOutData, dataSize)));
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_SampleRate>
{
    static OSStatus get(Impl const &impl, AudioUnitScope, AudioUnitElement, ::Float64 &value)
    {
        value = impl.getSampleRate();
        return noErr;
    }
    static OSStatus set(Impl &impl, AudioUnitScope, AudioUnitElement, ::Float64 const &value)
    {
        return makeErrorCode(impl.setSampleRate(value));
    }
};

template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_StreamFormat>
{
                        ...
                        ::AudioStreamBasicDescription const &format)
    {
        ...
        if (scope == kAudioUnitScope_Input)
        {
            auto &hostProxy(impl.host());
            if (element == 0)
                pTargetNumberOfChannels = &hostProxy.inputChannels_;
            else
                pTargetNumberOfChannels = &hostProxy.sideChannels_;
        }
        else
        {
            LE_ASSUME(scope == kAudioUnitScope_Output);
        ...
        bool const formatChanged((format.mSampleRate != impl.getSampleRate()) ||
...
template <> struct PropertyChangeDetector<kAudioUnitProperty_StreamFormat>
{
    ...
    PropertyChangeDetector(Impl const &impl, AudioUnitScope, AudioUnitElement)
        : sampleRate(impl.getSampleRate()), numberOfChannels(impl.numberOfInputChannels()),
          numberOfSideChannels(impl.numberOfSideChannels())
    {
    }

    template <class Impl> bool changed(Impl const &impl, AudioUnitScope, AudioUnitElement)
    {
        return (sampleRate != impl.getSampleRate()) ||
...
template <> struct PropertyValueCount<kAudioUnitProperty_SupportedNumChannels>
{
    template <class Impl>
    static unsigned int get(Impl const &, ::AudioUnitScope, ::AudioUnitElement)
    {
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_ElementCount>
{
                        ...
                        ::UInt32 &value)
    {
        ...
        case kAudioUnitScope_Input:
            value = hostProxy.sideChannels_ ? 2 : 1;
            break;
    ...
    static OSStatus set(Impl &impl, ::AudioUnitScope const scope, ::AudioUnitElement,
                        ::UInt32 const value)
    {
        //...mrmlj...SW HARDCODE...
        if (scope != kAudioUnitScope_Input)
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_ElementName>
{
    static OSStatus get(Impl const &impl, ::AudioUnitScope const scope,
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_Latency>
{
    static OSStatus get(Impl const &impl, AudioUnitScope, AudioUnitElement, ::Float64 &value)
    {
        value = impl.engineSetup().latencyInMilliseconds() / 1000;
        return noErr;
    }
}; // kAudioUnitProperty_Latency

template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_TailTime>
{
    static OSStatus get(Impl const &impl, AudioUnitScope, AudioUnitElement, ::Float64 &value)
    {
        value = Impl::maxTailSize;
        return noErr;
    }
}; // kAudioUnitProperty_TailTime

template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_MaximumFramesPerSlice>
{
    static OSStatus get(Impl const &impl, AudioUnitScope, AudioUnitElement, ::UInt32 &value)
    {
        value = impl.processBlockSize();
        return noErr;
    }
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_LastRenderError>
{
    static OSStatus get(Impl const &impl, AudioUnitScope, AudioUnitElement, ::OSStatus &value)
    {
        value = impl.lastRenderError_;
        return noErr;
    }
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_HostCallbacks>
{
    // Write only property but get required for change detection/notification...
    static OSStatus get(Impl const &impl, AudioUnitScope, AudioUnitElement,
                        ::HostCallbackInfo &hostCallbacks)
    {
        hostCallbacks = impl.host().callbacks();
        return noErr;
    }
    static OSStatus set(Impl &impl, AudioUnitScope, AudioUnitElement,
                        ::HostCallbackInfo const &hostCallbacks)
    {
        impl.host().callbacks() = hostCallbacks;
        return noErr;
    }
}; // kAudioUnitProperty_HostCallbacks

template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_SetRenderCallback>
{
    static OSStatus set(Impl &impl, ::AudioUnitScope, ::AudioUnitElement const bus,
                        ::AURenderCallbackStruct const &callback)
    {
        AUPluginBase::RenderDelegate &delegate(impl.inputConnections_[bus]);
        bool const connectionOverwritten(delegate.type() ==
                                         AUPluginBase::RenderDelegate::Connection);
...
template <> struct PropertyChangeDetector<kAudioUnitProperty_SetRenderCallback>
{
    PropertyChangeDetector(AUPluginBase const &plugin, AudioUnitScope, AudioUnitElement const bus)
        : currentDelegate(plugin.inputConnections_[bus])
    {
    }
    bool changed(AUPluginBase const &plugin, AudioUnitScope, AudioUnitElement const bus) const
    {
        return std::memcmp(&currentDelegate, &plugin.inputConnections_[bus],
                           sizeof(currentDelegate)) == 0;
    }
    AUPluginBase::RenderDelegate const currentDelegate;
}; // PropertyChangeDetector<kAudioUnitProperty_SetRenderCallback>

template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_MakeConnection>
{
    static ::OSStatus set(Impl &impl, ::AudioUnitScope, ::AudioUnitElement const bus,
                          ::AudioUnitConnection const &connection)
    {
        ...
        if (connection.sourceAudioUnit)
        {
            ...
            ::OSStatus const getFormatResult(::AudioUnitGetProperty(
                connection.sourceAudioUnit, kAudioUnitProperty_StreamFormat, kAudioUnitScope_Output,
            ...
            ::OSStatus const setFormatResult(
                PropertyHandler<Impl, kAudioUnitProperty_StreamFormat>::set(
                    impl, kAudioUnitScope_Input, bus, format));
...
template <>
struct PropertyChangeDetector<kAudioUnitProperty_MakeConnection>
    : PropertyChangeDetector<kAudioUnitProperty_SetRenderCallback>
{
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_ShouldAllocateBuffer>
{
    static OSStatus get(Impl const &impl, AudioUnitScope const scope,
                        ...
                        ::UInt32 const &value)
    {
        ...
        if (scope == kAudioUnitScope_Output)
            ...
            impl.inputConnections_[element].setShouldAllocateBuffer(should);
        return noErr;
    }
}; // kAudioUnitProperty_ShouldAllocateBuffer

template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_InPlaceProcessing>
{ // http://osdir.com/ml/coreaudio-api/2010-02/msg00042.html
    static OSStatus get(Impl const &impl, AudioUnitScope, AudioUnitElement, ::UInt32 &value)
    {
        value = impl.inPlaceProcessing_;
        return noErr;
    }
    static OSStatus set(Impl &impl, AudioUnitScope, AudioUnitElement, ::UInt32 const &value)
    {
        impl.inPlaceProcessing_ = (value != 0);
        return noErr;
    }
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_PresentPreset>
{
    static OSStatus get(Impl const &impl, AudioUnitScope, AudioUnitElement, ::AUPreset &preset)
    {
        preset.presetNumber = -1;
        preset.presetName =
            ::CFStringCreateWithCString(nullptr, impl.currentProgramName(), kCFStringEncodingUTF8);
        return noErr;
    }
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_FactoryPresets>
{
    static OSStatus get(Impl const &impl, AudioUnitScope, AudioUnitElement, ::CFArrayRef &presets)
    {
        LE_UNREACHABLE_CODE();
        presets = nullptr;
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_ClassInfo>
{
    static OSStatus get(Impl const &impl, AudioUnitScope, AudioUnitElement,
                        ::CFPropertyListRef &preset)
    {
        ::CFMutableDictionaryRef const dictionary(::CFDictionaryCreateMutable(
        ...
        if (!addToDictionary(dictionary, CFSTR(kAUPresetVersionKey), Impl::version) ||
            !addToDictionary(dictionary, CFSTR(kAUPresetTypeKey), description.componentType) ||
            !addToDictionary(dictionary, CFSTR(kAUPresetSubtypeKey),
                             description.componentSubType) ||
            !addToDictionary(dictionary, CFSTR(kAUPresetManufacturerKey),
        ...
        ::CFStringRef const currentPresetName(
            ::CFStringCreateWithCString(nullptr, impl.currentProgramName(), kCFStringEncodingUTF8));
                        ...
                        ::CFPropertyListRef const &preset)
    {
        ...
        static ::CFStringBuiltInEncodings constexpr encodings[] = {
            ...
            kCFStringEncodingASCII,         kCFStringEncodingNonLossyASCII,
            kCFStringEncodingWindowsLatin1, kCFStringEncodingISOLatin1};
  ...
  private:
    static bool addToDictionary(::CFMutableDictionaryRef const dictionary, ::CFStringRef const key,
                                ::OSType const value)
    {
...
template <> struct PropertyChangeDetector<kAudioUnitProperty_ClassInfo>
{
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_CocoaUI>
{
...
template <class Impl> struct PropertyHandler<Impl, Detail::auViewPropertyID>
{
    static OSStatus set(Impl &impl, AudioUnitScope, AudioUnitElement,
                        ObjC::NSView *const pParentView)
    {
        if (pParentView)
...
template <> struct PropertyChangeDetector<auViewPropertyID>
{
    PropertyChangeDetector(AUPluginBase const &, AudioUnitScope, AudioUnitElement) {}
    static bool changed(AUPluginBase const &, AudioUnitScope, AudioUnitElement) { return false; }
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_ParameterList>
{
...
template <> struct PropertyValueCount<kAudioUnitProperty_ParameterList>
{
    template <class Impl>
    static unsigned int get(Impl const &impl, ::AudioUnitScope const scope, ::AudioUnitElement)
    {
        return (scope == kAudioUnitScope_Global)
                   ? Impl::numberOfParameters((impl.host().canTryDynamicParameterList() &&
                                               impl.staticParameterListReported_)
                                                  ? &impl.program()
                                                  : nullptr)
                   : 0;
    }
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_DependentParameters>
{
                        ...
                        LE::Utility::Span<::AUDependentParameter> const dependentParameters)
    {
        ...
        Impl::getDependentParameters(
            reinterpret_cast<ParameterID const &>(parameterID), dependentParameters,
            (impl.host().canTryDynamicParameterList() && impl.staticParameterListReported_)
                ? &impl
                : nullptr);
        return noErr;
...
template <> struct PropertyValueCount<kAudioUnitProperty_DependentParameters>
{
    template <class Impl>
    static unsigned int get(Impl const &impl, ::AudioUnitScope const scope,
                            ::AudioUnitElement const parameterID)
    {
        LE_ASSUME(scope == kAudioUnitScope_Global);
        return Impl::numberOfDependentParameters(
            reinterpret_cast<ParameterID const &>(parameterID),
            (impl.host().canTryDynamicParameterList() && impl.staticParameterListReported_)
                ? &impl
                : nullptr);
    }
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_ParameterInfo>
{
    static OSStatus get(Impl const &impl, ::AudioUnitScope const scope,
                        ::AudioUnitElement const parameterID,
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_ParameterIDName> // short name
{
    static OSStatus get(Impl const &, ::AudioUnitScope const scope,
                        ::AudioUnitElement const parameterID,
                        ::AudioUnitParameterNameInfo & /*parameterNameInfo*/)
    {
        LE_ASSUME(scope == kAudioUnitScope_Global);
...
struct PropertyHandler<Impl, kAudioUnitProperty_ParameterClumpName> // clump = group
{
    static OSStatus get(Impl const &, ::AudioUnitScope const scope,
                        ::AudioUnitElement const parameterID,
                        ::AudioUnitParameterNameInfo &parameterClumpNameInfo)
    {
        LE_ASSUME(scope == kAudioUnitScope_Global);
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_ParameterStringFromValue>
{
    static OSStatus get(Impl const &impl, ::AudioUnitScope const scope,
                        ::AudioUnitElement const parameterID,
                        ::AudioUnitParameterStringFromValue &stringFromValue)
    {
        LE_ASSUME(scope == kAudioUnitScope_Global);
        LE_ASSUME(parameterID == stringFromValue.inParamID || !parameterID);
        std::array<char, 64> buffer;
        impl.getParameterDisplay(ParameterID{stringFromValue.inParamID}, buffer,
                                 stringFromValue.inValue);
        stringFromValue.outString =
            ::CFStringCreateWithCString(nullptr, buffer.begin(), kCFStringEncodingASCII);
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_ParameterValueFromString>
{
    static OSStatus get(Impl const &, ::AudioUnitScope const scope,
                        ::AudioUnitElement const parameterID,
                        ::AudioUnitParameterValueFromString &valueFromString)
    {
        LE_ASSUME(scope == kAudioUnitScope_Global);
        return kAudio_UnimplementedError;
    }
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_ParameterValueStrings>
{
    static OSStatus get(Impl const &, ::AudioUnitScope const scope,
                        ::AudioUnitElement const parameterID, ::CFArrayRef &parameterValueStrings)
    {
        LE_ASSUME(scope == kAudioUnitScope_Global);
        return kAudio_UnimplementedError;
    }
...
template <class Impl> struct PropertyHandler<Impl, kAudioUnitProperty_AUHostIdentifier>
{
    static OSStatus set(Impl &impl, ::AudioUnitScope const scope,
                        ::AudioUnitElement const parameterID,
                        ::AUHostVersionIdentifier const &hostIdentifier)
    {
        LE_ASSUME(scope == kAudioUnitScope_Global);
...
template <> struct PropertyChangeDetector<kAudioUnitProperty_AUHostIdentifier>
{
    PropertyChangeDetector(AUPluginBase const &, AudioUnitScope, AudioUnitElement) {}
    static bool changed(AUPluginBase const &, AudioUnitScope, AudioUnitElement) { return false; }
