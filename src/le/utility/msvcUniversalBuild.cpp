...
#define LE_ALTERNATE_SYMBOL(originalx86Symbol, originalx64Symbol, alternateSymbol)                 \
    LE_ALTERNATE_SYMBOL_IMPL(                                                                      \
        LE_ALTERNATE_SYMBOL_ARCH_SELECT(originalx86Symbol, originalx64Symbol), alternateSymbol)

#define LE_ALTERNATE_CDECL_SYMBOL(originalx86Symbol, originalx64Symbol, alternateSymbol)           \
    LE_ALTERNATE_SYMBOL(originalx86Symbol, originalx64Symbol,                                      \
                        LE_ALTERNATE_CDECL_SYMBOL_PREFIX(alternateSymbol))

extern "C" void __cdecl _leimpl_Xbad_alloc() { LE_UNREACHABLE_CODE(); }
extern "C" char const *__cdecl _leimpl_Syserror_map(int)
{
    LE_UNREACHABLE_CODE();
    return nullptr;
}
extern "C" char const *__cdecl _leimpl_Winerror_map(int)
{
    LE_UNREACHABLE_CODE();
    return nullptr;
}
...
extern "C" float __cdecl _leimpl_roundf(_In_ float _X)
{
    return static_cast<float>(_mm_cvtss_si32(_mm_set_ss(_X)));
}
...
#ifdef _DEBUG
LE_ALTERNATE_SYMBOL(___libm_sse2_sqrt_precise, __libm_sse2_sqrt_precise,
                    _leimpl___libm_sse2_sqrt_precise @ @8)
LE_ALTERNATE_SYMBOL(___libm_sse2_exp_precise, __libm_sse2_exp_precise,
                    _leimpl___libm_sse2_exp_precise @ @8)
LE_ALTERNATE_SYMBOL(___libm_sse2_log_precise, __libm_sse2_log_precise,
                    _leimpl___libm_sse2_log_precise @ @8)
LE_ALTERNATE_SYMBOL(___libm_sse2_pow_precise, __libm_sse2_pow_precise,
                    _leimpl___libm_sse2_pow_precise @ @16)
LE_ALTERNATE_SYMBOL(___libm_sse2_sin_precise, __libm_sse2_sin_precise,
                    _leimpl___libm_sse2_sin_precise @ @8)
LE_ALTERNATE_SYMBOL(___libm_sse2_cos_precise, __libm_sse2_cos_precise,
                    _leimpl___libm_sse2_cos_precise @ @8)

LE_ALTERNATE_SYMBOL(__libm_sse2_sqrt_precise, _libm_sse2_sqrt_precise,
                    _leimpl___libm_sse2_sqrt_precise @ @8)
LE_ALTERNATE_SYMBOL(__libm_sse2_exp_precise, _libm_sse2_exp_precise,
                    _leimpl___libm_sse2_exp_precise @ @8)
LE_ALTERNATE_SYMBOL(__libm_sse2_log_precise, _libm_sse2_log_precise,
                    _leimpl___libm_sse2_log_precise @ @8)
LE_ALTERNATE_SYMBOL(__libm_sse2_log10_precise, _libm_sse2_log10_precise,
                    _leimpl___libm_sse2_log10_precise @ @8)
LE_ALTERNATE_SYMBOL(__libm_sse2_pow_precise, _libm_sse2_pow_precise,
                    _leimpl___libm_sse2_pow_precise @ @16)
LE_ALTERNATE_SYMBOL(__libm_sse2_sin_precise, _libm_sse2_sin_precise,
                    _leimpl___libm_sse2_sin_precise @ @8)
LE_ALTERNATE_SYMBOL(__libm_sse2_cos_precise, _libm_sse2_cos_precise,
                    _leimpl___libm_sse2_cos_precise @ @8)
#endif // _DEBUG
...
extern "C" std::uint32_t __vectorcall _leimpl__ftoui3(float const _X)
{
    return _mm_cvttss_si32(_mm_set_ss(_X));
}
extern "C" std::uint32_t __vectorcall _leimpl__dtoui3(double const _X)
{
    std::uint32_t integer;
    {
        __asm fld _X __asm fistp integer
    }
    return integer;
}
extern "C" std::int64_t __vectorcall _leimpl__ftol3(float const _X)
{
    std::int64_t integer;
    {
        __asm fld _X __asm fistp integer
...
extern "C" std::int64_t __vectorcall _leimpl__dtol3(double const _X)
{
    std::int64_t integer;
    {
        __asm fld _X __asm fistp integer
...
extern "C" double __vectorcall _leimpl__ltod3(std::uint32_t const _Xlower,
                                              std::int32_t const _Xupper)
{
...
_leimpl___stdio_common_vsprintf(_In_ unsigned __int64 const _Options,
...
extern "C" int __CRTDECL
_leimpl__vsnprintf_l(_Out_writes_(_BufferCount) char *const _Buffer, _In_ size_t const _BufferCount,
                     _In_z_ _Printf_format_string_params_(2) char const *const _Format,
                     _In_opt_ _locale_t const _Locale, va_list _ArgList)
{
...
extern "C" int __CRTDECL _leimpl__vsnprintf(_Out_writes_(_BufferCount)
                                                _Post_maybez_ char *const _Buffer,
                                            _In_ size_t const _BufferCount,
...
LE_ALTERNATE_CDECL_SYMBOL(___stdio_common_vsprintf, __stdio_common_vsprintf,
                          _leimpl___stdio_common_vsprintf)
LE_ALTERNATE_CDECL_SYMBOL(___acrt_iob_func, __acrt_iob_func, _leimpl___acrt_iob_func)

#include "vcruntime_exception.h"

extern "C" void __cdecl _leimpl___std_exception_copy(__std_exception_data const *const from,
...
extern "C" void __cdecl _leimpl___std_exception_destroy(__std_exception_data *const data)
{
    if (data->_DoFree)
    {
        delete data->_What;
...
LE_ALTERNATE_CDECL_SYMBOL(___std_exception_destroy, __std_exception_destroy,
                          _leimpl___std_exception_destroy)
