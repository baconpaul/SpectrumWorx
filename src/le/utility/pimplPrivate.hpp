...
template <typename T1, typename T2> std::ptrdiff_t ptrdiff(T1 const *const p1, T2 const *const p2)
{
...
template <class Interface, class BaseInterface>
typename Implementation<Interface>::type &&impl(PImpl<Interface, BaseInterface> &&anInterface)
{
    return std::move(impl(anInterface));
}
template <class Interface, class BaseInterface>
typename Implementation<Interface>::type const &
impl(PImpl<Interface, BaseInterface> const &anInterface)
{
    return impl(const_cast<PImpl<Interface, BaseInterface> &>(anInterface));
}

template <class Interface>
typename Implementation<Interface>::type &
impl(PImpl<Interface, Detail::PImplTerminator> &interfaceBase)
{
    using Implementation = typename Implementation<Interface>::type;
...
impl(PImpl<Interface, Detail::PImplTerminator> &&interfaceBase)
{
    return std::move(impl(interfaceBase));
}
template <class Interface>
typename Implementation<Interface>::type const &
impl(PImpl<Interface, Detail::PImplTerminator> const &interfaceBase)
{
    return impl(const_cast<PImpl<Interface, Detail::PImplTerminator> &>(interfaceBase));
}

template <class Interface, class BaseInterface>
typename Implementation<Interface>::type &impl(HeapPImpl<Interface, BaseInterface> &anInterface)
{
    return impl(static_cast<PImpl<Interface, BaseInterface> &>(anInterface));
}
template <class Interface, class BaseInterface>
typename Implementation<Interface>::type &&impl(HeapPImpl<Interface, BaseInterface> &&anInterface)
{
...
template <class Interface, class BaseInterface>
typename Implementation<Interface>::type const &
impl(HeapPImpl<Interface, BaseInterface> const &anInterface)
{
    return impl(const_cast<HeapPImpl<Interface, BaseInterface> &>(anInterface));
}
...
typename Implementation<Interface>::type &&
impl(StackPImpl<Interface, storageSize, alignment, BaseInterface> &&implInterface)
{
    return static_cast<typename Implementation<Interface>::type &&>(
        impl(static_cast<typename Detail::StackPImplBase<Interface, BaseInterface>::type &&>(
            implInterface)));
}
template <class Interface, std::size_t storageSize, std::size_t alignment, class BaseInterface>
typename Implementation<Interface>::type &
...
template <class Interface, std::size_t storageSize, std::size_t alignment, class BaseInterface>
typename Implementation<Interface>::type const &
impl(StackPImpl<Interface, storageSize, alignment, BaseInterface> const &implInterface)
{
    return static_cast<typename Implementation<Interface>::type const &>(
        impl(static_cast<typename Detail::StackPImplBase<Interface, BaseInterface>::type const &>(
            implInterface)));
}

namespace Detail
{
template <std::size_t PlaceholderSize, std::size_t ImplementationSize> struct AssertStorageSize
{
    static_assert(PlaceholderSize >= ImplementationSize,
                  "Stack PImpl: insufficient preallocated storage");
};

template <std::size_t PlaceholderAlignment, std::size_t ImplementationAlignment>
struct AssertStorageAlignment
{
    static_assert(PlaceholderAlignment >= ImplementationAlignment,
                  "Stack PImpl: insufficient preallocated storage alignment");
};
} // namespace Detail
...
StackPImpl<Interface, storageSize, alignment, BaseInterface>::StackPImpl()
{
    ...
    Detail::AssertStorageAlignment<std::alignment_of<Placeholder>::value,
                                   std::alignment_of<Implementation>::value>();
...
StackPImpl<Interface, storageSize, alignment, BaseInterface>::StackPImpl(StackPImpl &&other)
{
    ...
    Implementation *LE_RESTRICT const pImpl(new (this)
                                                Implementation(std::move(impl(std::move(other)))));
    LE_ASSUME(pImpl);
}
...
StackPImpl<Interface, storageSize, alignment, BaseInterface>::StackPImpl(T &&constructionArgument)
{
    ...
    static_assert(sizeof(*this) >= sizeof(Implementation),
                  "Stack PImpl: insufficient preallocated storage");
    static_assert(std::alignment_of<Placeholder>::value >= std::alignment_of<Implementation>::value,
                  "Stack PImpl: insufficient preallocated storage alignment");
    Implementation *LE_RESTRICT const pImpl(
        new (this) Implementation(std::forward<T>(constructionArgument)));
    LE_ASSUME(pImpl);
}
