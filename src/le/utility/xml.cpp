...
#ifdef _MSC_VER
extern "C" LE_WEAK_FUNCTION void rapidxml_parse_error_handler(char const * /*const what*/,
                                                              void * /*const where*/)
{
    std::terminate();
}
#pragma comment(                                                                                   \
    linker,                                                                                        \
    "/alternatename:?parse_error_handler@rapidxml@@YAXPEBDPEAX@Z=rapidxml_parse_error_handler")
#else
LE_WEAK_FUNCTION void rapidxml::parse_error_handler(char const * /*const what*/,
                                                    void * /*const where*/)
{
    std::terminate();
}
