...
void TransientsExtractor::process(ChannelState &cs,
                                  ChannelData_ReIm &data) const // Use reals and imags.
{
    // Locals:
    float tsik;
    float sik;
    ...
    for (InclusiveIndexRange workingRange(workingRange_); workingRange; ++workingRange)
    {
        ...
        // Why?
        tr = data.reals()[*workingRange] * cs.prevReals_[*workingRange] +
             data.imags()[*workingRange] * cs.prevImags_[*workingRange];
        ti = -data.reals()[*workingRange] * cs.prevImags_[*workingRange] +
             data.imags()[*workingRange] * cs.prevReals_[*workingRange];
        ...
        //
        tsik = (cs.processedPrevReals_[*workingRange] * processedImag_) -
               (cs.processedPrevImags_[*workingRange] * processedReal_);
        sik = (tsik * tsik);
        sik -= threshold_;
