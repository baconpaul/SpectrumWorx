...
namespace Detail
{
template <typename T> bool isValueInRange(T value, T rangeMinimum, T rangeMaximum);
...
struct GetTraitImpl<TraitTag, FirstTrait, TraitsSequence...>
    : GetTraitImpl<TraitTag, TraitsSequence...>
{
};
...
template <int minimumValue, int maximumValue, int defaultValue> struct LinearParameterTraitsBase
{
  public: // Types.
    ...
    : LinearParameterTraitsBase<minimumValue, maximumValue, defaultValue>
{
  ...
  public: // Values
    ...
    {
        static value_type const value(LinearFloatParameterTraitsBase::unscaledMinimum /
                                      static_cast<value_type>(rangeScaleFactor));
        return value;
    }
    static value_type const &maximum()
    {
        static value_type const value(LinearFloatParameterTraitsBase::unscaledMaximum /
                                      static_cast<value_type>(rangeScaleFactor));
        return value;
    }
    static value_type const &default_()
    {
        static value_type const value(LinearFloatParameterTraitsBase::unscaledDefault /
                                      static_cast<value_type>(rangeScaleFactor));
        return value;
    }
...
struct LinearFloatParameterTraits<TraitPack<TraitsParam...>, DefaultsParam...>
    : LinearFloatParameterTraitsBase<
          GetTraitDefaulted<Traits::Tag::Minimum, TraitPack<TraitsParam...>,
                            DefaultsParam...>::type::value,
          GetTraitDefaulted<Traits::Tag::Maximum, TraitPack<TraitsParam...>,
                            DefaultsParam...>::type::value,
          GetTraitDefaulted<Traits::Tag::Default, TraitPack<TraitsParam...>,
                            DefaultsParam...>::type::value,
...
struct LinearIntegerParameterTraits<T, TraitPack<TraitsParam...>, DefaultsParam...>
    : LinearParameterTraitsBase<GetTraitDefaulted<Traits::Tag::Minimum, TraitPack<TraitsParam...>,
                                                  DefaultsParam...>::type::value,
                                GetTraitDefaulted<Traits::Tag::Maximum, TraitPack<TraitsParam...>,
                                                  DefaultsParam...>::type::value,
                                GetTraitDefaulted<Traits::Tag::Default, TraitPack<TraitsParam...>,
...
using LinearSignedIntegerParameterTraits =
    LinearIntegerParameterTraits<std::int16_t, Traits, Defaults...>;

template <class Traits, class... Defaults>
using LinearUnsignedIntegerParameterTraits =
    LinearIntegerParameterTraits<std::uint16_t, Traits, Defaults...>;
} // namespace Detail
