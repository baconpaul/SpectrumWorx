...
template <int sourceRangeOffset, unsigned int sourceRangeSize, unsigned int sourceRangeScaleFactor,
          class Parameter>
struct DirectlyConvertible
    : std::integral_constant<bool, sourceRangeOffset == Parameter::unscaledMinimum &&
                                       sourceRangeSize == (Parameter::unscaledMaximum -
...
typename std::enable_if<DirectlyConvertible<sourceRangeOffset, sourceRangeSize,
                                            sourceRangeScaleFactor, Parameter>::value,
                        Target>::type
...
convertLinearValueToParameterValue(Source const sourceValue, LinearParameterTag)
{
    ...
    return Math::convertLinearRange<Target, Source, sourceRangeOffset, sourceRangeSize,
        ...
        sourceValue, static_cast<Target>(Parameter::minimum()),
        static_cast<Target>(Parameter::maximum()));
}
...
typename std::enable_if<DirectlyConvertible<targetRangeOffset, targetRangeSize,
                                            targetRangeScaleFactor, Parameter>::value,
                        Target>::type
