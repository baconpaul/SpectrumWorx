...
Target convertLinearValueToParameterValue(Source const sourceValue, DummyTag);
...
Target convertParameterValueToLinearValue(Source const sourceValue, DummyTag);
} // namespace Detail
#endif // __GNUC__

template <typename Source, int sourceRangeOffset, unsigned int sourceRangeSize,
          unsigned int sourceRangeScaleFactor, class Parameter,
          typename Target>
Target convertLinearValueToParameterValue(Source const sourceValue) ///< \throws nothing
{
    return Detail::convertLinearValueToParameterValue<Source, sourceRangeOffset, sourceRangeSize,
                                                      sourceRangeScaleFactor, Parameter, Target>(
        sourceValue, typename Parameter::Tag());
}
...
{
    return Detail::convertLinearValueToParameterValue<Source, sourceRangeOffset, sourceRangeSize,
                                                      sourceRangeScaleFactor, Parameter,
                                                      typename Parameter::value_type>(
        sourceValue, typename Parameter::Tag());
}
...
template <typename Target, int targetRangeOffset, unsigned int targetRangeSize,
          ...
          typename Source>
Target convertParameterValueToLinearValue(Source const sourceValue) ///< \throws nothing
{
    return Detail::convertParameterValueToLinearValue<Target, targetRangeOffset, targetRangeSize,
                                                      targetRangeScaleFactor, Parameter>(
        sourceValue, typename Parameter::Tag());
}
...
template <typename Target, int targetRangeOffset, unsigned int targetRangeSize,
          ...
          class Parameter>
Target convertParameterValueToLinearValue(Parameter const &source) ///< \throws nothing
{
    return Detail::convertParameterValueToLinearValue<Target, targetRangeOffset, targetRangeSize,
                                                      targetRangeScaleFactor, Parameter>(
