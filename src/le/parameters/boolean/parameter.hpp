...
{
template <bool defaultValue = false> struct BooleanParameterTraits
{
  public: // Types.
...
template <> struct Boolean::Modify<>
{
    using type = Detail::BooleanParameterTraits<>;
};
template <> struct Boolean::Modify<Parameters::Traits::Default<false>>
{
    using type = Detail::BooleanParameterTraits<false>;
};
template <> struct Boolean::Modify<Parameters::Traits::Default<true>>
{
