...
class EnumeratedParameter : public Parameter<Detail::EnumeratedParameterTraits<numberOfValues>>
{
  protected:
  ...
  public:
    ...
    explicit EnumeratedParameter(binary_type const initialValue = EnumeratedParameter::default_())
        : EnumeratedParameter::type(initialValue)
    {
    }
}; // class EnumeratedParameter
...
#define LE_ENUMERATED_PARAMETER(parameterName, valueSequence)                                      \
    ...
    {                                                                                              \
      ...
      public:                                                                                      \
        ...
        enum value_type : /*std::*/ uint_fast8_t                                                   \
        {                                                                                          \
