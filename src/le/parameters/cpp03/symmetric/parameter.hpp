...
struct SymmetricFloatParameterTraits
    : LinearFloatParameterTraitsBase<
          0 - static_cast<int>(GetTraitDefaulted<Traits::Tag::MaximumOffset, TraitsParam,
                                                 DefaultsParam>::type::value),
          0 + GetTraitDefaulted<Traits::Tag::MaximumOffset, TraitsParam,
                                DefaultsParam>::type::value,
          0,
...
struct SymmetricIntegerParameterTraits
    : LinearParameterTraitsBase<0 - static_cast<int>(
                                        GetTraitDefaulted<Traits::Tag::MaximumOffset, TraitsParam,
                                                          DefaultsParam>::type::value),
                                0 + GetTraitDefaulted<Traits::Tag::MaximumOffset, TraitsParam,
                                                      DefaultsParam>::type::value,
                                0>
