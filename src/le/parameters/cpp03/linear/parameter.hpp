...
template <class TraitTag, class Traits, class Defaults> struct GetTraitDefaulted
{
    typedef typename boost::mpl::at<Traits, TraitTag>::type UserSpecified;
    typedef
        typename boost::mpl::eval_if<std::is_same<UserSpecified, boost::mpl::void_>,
                                     boost::mpl::at<Defaults, TraitTag>, UserSpecified>::type type;
};
...
struct LinearFloatParameterTraits
    : LinearFloatParameterTraitsBase<
          ...
          GetTraitDefaulted<Traits::Tag::ValuesDenominator, TraitsParam,
...
template <class Traits, class Defaults>
struct LinearUnsignedIntegerParameterTraits
    : LinearIntegerParameterTraits<unsigned int, Traits, Defaults>
{
};
} // namespace Detail
...
struct LinearSignedInteger
{
    template <class NewTraits> struct Modify
    {
        typedef Detail::LinearSignedIntegerParameterTraits<NewTraits,
...
struct LinearUnsignedInteger
{
    template <class NewTraits> struct Modify
    {
        typedef Detail::LinearUnsignedIntegerParameterTraits<NewTraits,
                                                             boost::mpl::map1<Traits::Unit<0>>>
            type;
    };
};
...
struct LinearFloat
{
    template <class NewTraits> struct Modify
    {
        typedef Detail::LinearFloatParameterTraits<
            NewTraits, boost::mpl::map2<Traits::ValuesDenominator<1>, Traits::Unit<0>>>
            type;
    };
};
