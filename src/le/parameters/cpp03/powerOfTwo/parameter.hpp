...
template <class ArgumentPack> struct PowerOfTwoParameterTraits
{
  public:
    ...
    static value_type const unscaledMinimum =
        boost::mpl::at<ArgumentPack, Traits::Tag::Minimum>::type::value;
    static value_type const unscaledMaximum =
        boost::mpl::at<ArgumentPack, Traits::Tag::Maximum>::type::value;
    static value_type const unscaledDefault =
        boost::mpl::at<ArgumentPack, Traits::Tag::Default>::type::value;
...
template <typename Trait0, typename Trait1, typename Trait2>
class PowerOfTwoParameter
