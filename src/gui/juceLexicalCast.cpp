...
char *numberToString(char *t, unsigned int const n) noexcept
{
    return t + LE::Utility::lexical_cast(n, t);
}

char *doubleToString(char * /*const*/ buffer, int const numChars, double const n,
