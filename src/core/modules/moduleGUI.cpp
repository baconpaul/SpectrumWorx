...
LE_NOTHROW LE_COLD ModuleGUI::~ModuleGUI() {}
...
LE_NOTHROW void ModuleGUI::setSharedParameter(std::uint_fast8_t const sharedParameterIndex,
...
LE_NOTHROW float ModuleGUI::setEffectParameter(std::uint_fast8_t const effectParameterIndex,
                                               float const parameterValue)
{
...
LE_NOTHROW void ModuleGUI::setSharedParameterFromLFO(std::uint_fast8_t const sharedParameterIndex,
...
LE_NOTHROW void ModuleGUI::setEffectParameterFromLFO(std::uint_fast8_t const effectParameterIndex,
                                                     LFO::value_type const lfoValue)
{
    //...mrmlj...AutomatedModuleImpl duplication
    auto const parameterValue(ModuleParameters::normalisedToParameterValue(
